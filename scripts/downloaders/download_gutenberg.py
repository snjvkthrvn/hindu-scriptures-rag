...
class GutenbergDownloader:
    ...
    TEXTS = [
        GutenbergText(
            id=2388,
            title="Bhagavad Gita",
            description="Edwin Arnold's translation",
            format='txt'
        ),
        GutenbergText(
            id=15474,
        ...
        GutenbergText(
            ...
            description="With Shankara's commentary",
            format='txt'
        ),
        GutenbergText(
            id=42541,
    ...
    def __init__(self, base_dir: Path):
        ...
        self.session.headers.update({
            'User-Agent': 'Mozilla/5.0 (Hindu Scripture RAG Pipeline)'
        })
