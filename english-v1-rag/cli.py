"""Interactive CLI for querying Hindu scriptures (English-only edition).

Usage:
    python english-v1-rag/cli.py
...
def print_banner():
    print("\n" + "=" * 60)
    print("  Hindu Scriptures RAG — English Edition")
    print("  ~14,000 verses: Vedas, Upanishads, Gita, Epics & more")
    print("=" * 60)
