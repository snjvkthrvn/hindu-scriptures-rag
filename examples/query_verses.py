...
class VerseQuery:
    ...
    def get_by_category(self, category: str) -> List[Dict[str, Any]]:
        ...
        return [
            v for v in self.verses
            if v.get('metadata', {}).get('category', '').lower() == category
        ]
    ...
    def get_statistics(self) -> Dict[str, Any]:
        ...
        stats = {
            ...
            'themes': Counter(
                ...
                for theme in v.get('metadata', {}).get('themes', [])
            ),
...
def main():
    ...
    parser.add_argument(
        '--theme',
        help='Get verses by theme'
    )
    parser.add_argument(
        '--domain',
        help='Get verses by life domain'
    )
    parser.add_argument(
        '--source',
        help='Get verses from specific source'
    )
    parser.add_argument(
        '--stats',
        action='store_true',
